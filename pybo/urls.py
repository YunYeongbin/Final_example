...
urlpatterns = [
    ...
    path('vote/question/<int:question_id>/', views.vote_views.vote_question, name='vote_question'),
    path('vote/question/<int:answer_id>',views.vote_views.vote_answer, name='vote_answer')
]